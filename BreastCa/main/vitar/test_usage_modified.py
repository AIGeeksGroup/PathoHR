...
class AdaptiveTokenMerger(nn.Module):
    def __init__(
        ...
        elif similarity_method == 'attention_score':
            self.similarity = AttentionSimilarity(dim, heads, temperature)
        else:
...
if __name__ == "__main__":
    ...
    similarity_method = 'semantic'  # Try different methods: 'pooled_attention', 'euclidean', 'cosine', 'semantic','attention_score'
    dis_save_path = os.path.join(save_path, similarity_method)
